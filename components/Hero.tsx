...
const Hero: React.FC = () => {
    ...
    return (
        <section className="relative h-[65vh] md:h-[80vh] w-full flex items-center justify-center text-center overflow-hidden">
            ...
            >
                <source src="https://res.cloudinary.com/dsajhtkyy/video/upload/v1761565958/%D0%B7%D0%B0%D0%B4%D0%BD%D0%B8%D0%B9_%D1%84%D0%BE%D0%BD_16-9_jq1thh.mp4" type="video/mp4" />
